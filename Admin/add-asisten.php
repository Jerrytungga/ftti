...
if (isset($_POST['simpan'])) {
    ...
    if ($foto != '') {
        if (move_uploaded_file($sumber, $target . $foto)) {
            $insert_data = mysqli_query($conn, "INSERT INTO `asisten`(`nip`, `image`, `name`, `gender`) VALUES ('$nip','$foto','$name','$jsk')");
            echo ("<script LANGUAGE='JavaScript'>
    window.alert('Data Successfully');
    window.location.href='all_Asisten.php';
    </script>");
        }
    } else { ?>
        <script>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Add Asisten</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Add Asisten</a></li>
                            </ul>
