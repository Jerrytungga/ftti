...
if (isset($_POST['simpan'])) {
    ...
    if ($foto != '') {
        if (move_uploaded_file($sumber, $target . $foto)) {
            $insert_data = mysqli_query($conn, "INSERT INTO `traines`(`nip`, `name`, `foto`, `angkatan`, `gender`,`semester`,`Asisten`) VALUES ('$nip','$name','$foto','$batch','$jenis_kelamin','$semester','$asi')");
?>
            <script>
