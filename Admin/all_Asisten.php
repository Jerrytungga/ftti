    ...
    <div class="all-content-wrapper">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">All Asisten</span>
                                            </li>
        ...
        <div class="contacts-area mg-b-15">
            <div class="container-fluid">
                <div class="row">
                    <?php
                    $data = mysqli_query($conn, "SELECT * FROM `asisten` ");
                    foreach ($data as $row) :
                    ?>
                        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 ">
                            <div class="student-inner-std res-mg-b-30 mg-b-10">
                                <div class="student-img">
                                    <img src="img/asisten/<?= $row['image']; ?>" alt="" />
                                </div>
                                <br>
                                <div class="student-dtl">
                                    <h6><?= $row['name']; ?></h6>
                                    <a href="edit-asisten.php?nip=<?= $row['nip']; ?>" class="btn btn-warning">Edit</a>
                                    <a href="asisten-profile.php?nip=<?= $row['nip']; ?>" class="btn btn-primary">View Profile</a>
                                    <br><br>
                                    <form action="qrcode_asisten.php" method="POST" enctype="multipart/form-data">
