...
$nip = $_GET['nip'];
$data = mysqli_query($conn, "SELECT * FROM `asisten`   where `nip`=$nip");
$asisten = mysqli_fetch_array($data);
include 'session.php';
?>
<!doctype html>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Profile Asisten</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="profile-info-inner">
                            <div class="profile-img">
                                <img src="img/asisten/<?= $asisten['image']; ?>" alt="" height="150" width="150" class="mb-2">
                            </div>
                            <div class="profile-details-hr">
                                <div class="row">
                                    <div class="col">
                                        <div class="address-hr">
                                            <p><b>Name</b><br /> <?= $asisten['name']; ?></p>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="profile-img">
                                            <?php
                                            if ($asisten['qr_code'] == NULL) { ?>
                                                <center>
                                                    <h6 class="font-weight-bold text-danger font-italic">QR Code Belum ada</h6>
                                                </center>
                                            <?php
                                            } else { ?>
                                                <img src="img/fotoqr/<?= $asisten['qr_code']; ?>" alt="" height="10" width="10" class="mb-2">
